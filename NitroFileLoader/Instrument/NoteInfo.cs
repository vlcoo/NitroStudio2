...
public class NoteInfo : IReadable, IWriteable
{
    ...
    public override bool Equals(object obj)
    {
        ...
        //If content matches.
        return n.Attack == Attack && n.BaseNote == BaseNote && n.Decay == Decay && n.InstrumentType == InstrumentType &&
               n.Pan == Pan && n.Release == Release && n.Sustain == Sustain && n.WarId == WarId && n.WaveId == WaveId;
    }
    ...
    public NoteInfo Duplicate()
    {
        return new NoteInfo
        {
            Attack = Attack, BaseNote = BaseNote, Decay = Decay, InstrumentType = InstrumentType, Key = Key, Pan = Pan,
            Release = Release, Sustain = Sustain, WarId = WarId, WaveId = WaveId
        };
    }
}